...
<div class="container">
        <div class="row">
          ...
          <div class="tab-content" id="myTabContent">
            <form id="login-form" class="tab-pane  show active" role="tabpanel" aria-labelledby="login-tab" action="<?php echo URLROOT; ?>/Admins/editPropertyRent/<?php echo $data['propertyId']; ?>" method="post" role="form" >
            <div class="card card-body bg-light mt-5">
                <h1 class="h3 mb-3 font-weight-normal">Edit property</h1>                   
                    <div class="form-group">
                        <label for="propertyName">Property Name: <sup>*</sup></label>
                        <input type="text" name="propertyName" class="form-control form-control-lg <?php  echo (!empty($data['propertyNameErr'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['propertyName']; ?>">
                        <!-- <span class="invalid-feedback"><?php //echo $data['propertyNameErr']; ?></span> -->
                    </div>
                    <div class="form-group">
                        <label for="propertyDesc">Property Description: <sup>*</sup></label>
                        <textarea type="text" name="propertyDesc" Placeholder="Property details" class="form-control form-control-lg <?php //echo (!empty($data['propertyDescErr'])) ? 'is-invalid' : ''; ?>" value=""><?php echo $data['propertyDesc']; ?></textarea>
                    ...
                    <div class="form-group">
                            ...
                            <textarea type="text" name="propertyPrice" Placeholder="e.g 200,000" class="form-control form-control-lg <?php echo (!empty($data['propertyPriceErr'])) ? 'is-invalid' : ''; ?>" value=""><?php echo $data['propertyPrice']; ?></textarea>
                            <!-- <span class="invalid-feedback"><?php  //echo $data['propertySizeErr']; ?></span> -->
                            </div>
                            <div class="form-group">
                        <label for="propertyTown">Town/Suburb <sup>*</sup></label>
                        <input type="text" name="propertyTown" class="form-control form-control-lg <?php  echo (!empty($data['propertyTownErr'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['propertyTown']; ?>">
                        <!-- <span class="invalid-feedback"><?php //echo $data['propertyTownErr']; ?></span> -->
                    </div>
                    <div class="form-group">
                        <label for="locationDesc">Location Description: <sup>*</sup></label>
                        <textarea type="text" name="locationDesc" Placeholder="closest bus stop, landmark etc" class="form-control form-control-lg <?php echo (!empty($data['locationDescErr'])) ? 'is-invalid' : ''; ?>" value=""><?php echo $data['locationDesc']; ?></textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="txtValue" type="text" name="amenities" Placeholder="<?php echo $data['amenities']; ?>" class="form-control form-control-lg <?php echo (!empty($data['postBodyErr'])) ? 'is-invalid' : ''; ?>" value="<?php // echo $data['postBody']; ?>"></textarea>
                        <!-- <span class="invalid-feedback"><?php  //echo $data['postBodyErr']; ?></span> -->
                    </div>
                    <div class="form-group">
                        <label for="validationCustom04">Bedrooms</label>
                        <input type="number" name="bedrooms" placeholder="No of Bedrooms" class="form-control form-control-lg <?php  echo (!empty($data['bedroomsErr'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['bedrooms']; ?>">
                        <!-- <span class="invalid-feedback"><?php //echo $data['bedroomsErr']; ?></span> -->
                    </div>
                    
                        <div class="form-group">
                            <label for="toilets">Bathrooms/Toilets</label>
                            <input type="number" name="toilets" placeholder="No of Toilets/Bathrooms" class="form-control form-control-lg <?php  echo (!empty($data['toiletsErr'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['toilets']; ?>">
                        ...
                        <div id="sale" class="categories" style="display:none">
                            ...
                            <input type="text" name="propertySize" Placeholder="e.g 4plots, 100 by 200" class="form-control form-control-lg <?php echo (!empty($data['postBodyErr'])) ? 'is-invalid' : ''; ?>" value="<?php  echo $data['propertySizeErr']; ?>" />
                            <!-- <span class="invalid-feedback"><?php  //echo $data['propertySizeErr']; ?></span> -->
                            </div>                         
                        </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="submit" formmethod="post" formaction="<?php echo URLROOT; ?>/Admins/editPropertyRent/<?php echo $data['propertyId']; ?>" value="Edit" tabindex="4" class="btn btn-primary btn-block">
