...
<div class="container-fluid">
  ...
  <div class="alert alert-primary" role="alert">
        <h4 class="alert-heading">Selected filters</h4>
        <form action="<?php echo URLROOT; ?>/Admins/filCheck" method="post">
              <div class="form-row align-items-center">
                <div class="input-group col my-1">
                  ...
                  <div class="input-group-append">
                    <button class="btn btn-outline-secondary" type="submit" formaction="<?php echo URLROOT; ?>/Admins/filCheck" formmethod="post" class="btn btn-primary">Search</button>
                  </div>
                </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover">
         <nav aria-label="Page navigation example">
          <ul class="pagination">
            <li class="page-item "><a class="page-link" href="<?php echo URLROOT; ?>/Admins/filCheck/?page=<?php echo $data['previous']; ?>">Previous</a></li>
            <?php for ($i=1; $i<=$data['pages']; $i++) : ?>
            <li class="page-item <?php ($i == $data['page'] ? print 'active' : '')?>"><a class="page-link" href="<?php echo URLROOT; ?>/Admins/filcheck/?page=<?php echo $i; ?>">            
            <?php echo $i; ?>
            </a></li>
                <?php endfor; ?>
            <li class="page-item"><a class="page-link" href="<?php echo URLROOT; ?>/Admins/filCheck/?page=<?php echo $data['next']; ?>">Next</a></li>
          </ul>
        </nav>
