                     ...
                     <!--  <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col">
                              ...
                              <input type="email" name="newEmail" placeholder="you@email.com" title="enter your new email." class="form-control form-control-lg <?php echo (!empty($data['emailErr'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['email']; ?>">
